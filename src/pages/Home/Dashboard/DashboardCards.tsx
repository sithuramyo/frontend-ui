...
import { UsersIcon, CalendarDaysIcon, ClockIcon, UserPlusIcon } from 'lucide-react';
...
const DashboardCards: React.FC<DashboardCardsProps> = ({ onCardClick, activeCard }) => {
  const cards: CardData[] = [
    ...
    },
    {
      ...
      icon: UserPlusIcon, // Icon has been changed here
      counts: [{ label: 'Total', value: 400 }],
        ...
        return (
          ...
          >
            ...
            <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
              <CardTitle className="text-lg text-[#051463] font-bold">
                {card.title}
              </CardTitle>
            ...
            <CardContent>
              <div className="flex items-center gap-2 mb-2">
                {card.counts.map((count, index) => (
                  <Badge key={index} variant="secondary" className="text-md font-bold p-1 px-2 flex items-center gap-2">
