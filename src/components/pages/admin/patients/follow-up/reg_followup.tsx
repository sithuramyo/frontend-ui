...
import { Calendar, UserCheck, AlertTriangle, Syringe, Shield, HelpCircle, CheckCircle2, XCircle, UserPlus } from "lucide-react";
...
const Reg_followup = () => {
  ...
  const [treatmentChangeDate, setTreatmentChangeDate] = useState<Date | undefined>(new Date());
  ...
  const handleHivTestChange = (role: string, testNumber: number, value: string) => {
    ...
    // If Test 1 is selected and the value is "Non-Reactive"
    if (testNumber === 1 && safeValue === "Non-Reactive") {
      setHivResults(prevResults => ({
        ...prevResults,
        [role]: { ...prevResults[role], test1: safeValue, test2: null, test3: null, final: "Negative" },
      }));
    } else {
      setHivResults(prevResults => ({
        ...prevResults,
  ...
  const getFinalHivResult = (test1Result: HivTestResult, test2Result: HivTestResult, test3Result: HivTestResult): HivFinalResult => {
    // This logic is now mostly handled in the handler, but we keep this for other cases
    if (test1Result === "Non-Reactive") return "Negative"; // This case is now handled proactively
  ...
  useEffect(() => {
    ["Self", "Partner 1", "Partner 2"].forEach((role) => {
      ...
      // We only need to compute if test1 is Reactive, as Non-Reactive is handled in the onChange handler
      if (test1 === "Reactive" && test2 && test3) {
      ...
      } else if (hivResults[role].final && test1 !== "Non-Reactive") {
        setHivResults((prevResults) => ({
          ...prevResults,
            ...
            <div className="rounded-t-2xl bg-gray-700 px-8 py-6 flex items-center justify-between gap-3 mb-8 shadow-md">
              ...
              <div className="flex items-start gap-2 w-full">
                ...
                <div className="flex flex-col items-center gap-2">
                  <div className="inline-flex items-center px-3 py-1 rounded-r-full bg-[#FAFAFA] text-md text-[#051463] font-bold font-mono">
                    001/000001
                  </div>
                  {/* <span className="text-xs text-gray-200">Auto-generated</span> */}
                </div>
              </div>
              {/* Expand/Collapse All */}
            ...
            >
              ...
              <AccordionItem value="item-5" className="bg-[#f9f7f7] py-4 pr-4 data-[state=open]:bg-blue-50">
                ...
                <AccordionContent className="pt-4 pb-2 pl-4 space-y-6">
                  ...
                  {/* Treatment Option, Type, and Start Date Group */}
                  <div className="bg-gray-50 rounded-lg p-4 space-y-7">
                    <Label className="font-bold text-lg">Treatment Details</Label>
                  ...
                  <div className="bg-gray-50 rounded-lg p-4 space-y-4">
                    <Label className="font-bold text-lg">Medication</Label>
                    <RadioGroup defaultValue="Methadone" className="space-y-3">
                      {[
                        ...
                        <div key={option.label} className="flex flex-wrap items-center gap-2">
                          ...
                          {option.input && (
                            <Input placeholder="Specify other" className=" bg-white w-[300px]" />
                          )}
                    ...
                    <div className="flex flex-col gap-2 py-4">
                      <Label>Treatment Change Date <span className="text-red-500">*</span></Label>
                      <DatePicker
                        date={treatmentChangeDate}
                        setDate={setTreatmentChangeDate}
                  ...
                  {/* Refer for & Next Appointment Group */}
                  <div className="bg-gray-50 rounded-lg p-4 space-y-4">
                    {/* <Label className="font-bold text-lg">Referral & Appointment</Label> */}
                    ...
                    <div className="space-y-2">
                      ...
                      <div className="grid md:grid-cols-3 gap-4">
                        ...
                        <div className="md:col-span-3 flex items-center space-x-2">
                          ...
                          <Input className="w-[300px] bg-white" />
                        </div>
                      </div>
                    </div>
